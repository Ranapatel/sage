...
const COMMERCIAL_AIRPORTS = [
  ...
  { iata: 'KUU', icao: 'VIBR', name: 'Kullu–Manali Airport (Bhuntar)', city: 'Kullu', country: 'India', latitude: 31.8767, longitude: 77.1542, keywords: ['kullu', 'manali', 'bhuntar', 'himachal'] },
...
const NON_AIRPORT_CITIES_MAP = {
  ...
  manali: { nearestIata: 'KUU', distanceKm: 50, alternateIata: 'IXC' },
