/**
 * Utility for determining city country and whether route is domestic or international.
 */
...
export function isSameCountry(origin: string, destination: string): boolean {
