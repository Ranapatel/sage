  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs animate-fade-in overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 w-full max-w-3xl shadow-2xl overflow-hidden my-8 transition-all">
        ...
        {/* ── Modal Header (redBus Brand Colors: Red / Dark Navy Gradient) ── */}
        <div className="bg-gradient-to-r from-red-800 via-rose-950 to-slate-950 text-white p-6 relative">
          <button
            type="button"
            onClick={onClose}
          ...
          <div className="flex items-center gap-2.5 mb-2">
            <span className="px-3 py-1 rounded-full bg-red-600 text-white font-extrabold text-xs uppercase tracking-wider flex items-center gap-1 shadow-xs">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4 text-xs text-rose-100 font-medium border-t border-rose-800/60 pt-3">
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-black text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-2">
              <Bus size={16} className="text-red-600" />
              Bus Route Breakdown
            </h4>
