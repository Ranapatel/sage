...
function BusCard({ bus }: BusCardProps) {
  ...
  return (
    <div className="group bg-white border border-[#E8E0D8] hover:border-[#EA580C] transition-all duration-300 hover:shadow-xl rounded-3xl p-4 sm:p-5 md:p-6 space-y-3.5 sm:space-y-4 relative overflow-hidden flex flex-col justify-between">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h4 className="font-black text-[#1A1A1A] text-base leading-tight font-display">
                {bus.operator}
              </h4>
              {bus.rating != null && (
      ...
      <div className="bg-[#FFFBF7]/80 border border-[#E8E0D8]/90 rounded-2xl p-3.5 sm:p-4 space-y-1.5 relative z-10">
        ...
        <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 sm:gap-4">
          ...
          <div className="text-left shrink-0 min-w-[65px] sm:min-w-[85px]">
            <div className="text-xl sm:text-2xl font-black text-[#1A1A1A] leading-none font-display">
              {bus.departure}
            </div>
            <div className="text-xs font-black text-[#EA580C] uppercase tracking-wider mt-1">
              Depart
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center px-1 sm:px-3">
            <span className="text-[10px] sm:text-xs font-black text-[#6B6B6B] mb-1 bg-white border border-[#E8E0D8] px-2.5 py-0.5 rounded-full shadow-2xs">
              {bus.duration}
            </span>
            <div className="w-full flex items-center justify-center relative my-1">
              ...
              <div className="absolute bg-white border border-[#E8E0D8] rounded-full p-0.5 shadow-2xs flex items-center justify-center w-6 h-6 z-10 text-[#EA580C]">
                <Bus size={12} />
              </div>
            </div>
          </div>
          ...
          <div className="text-right shrink-0 min-w-[65px] sm:min-w-[85px]">
            ...
            <div className="text-xs font-black text-[#1A1A1A] uppercase tracking-wider mt-1">
              Arrive
            </div>
          </div>
      ...
      <div className="pt-3 border-t border-[#E8E0D8]/80 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 relative z-10">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button
            onClick={handleBook}
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl font-black text-xs sm:text-sm bg-[#EA580C] hover:bg-[#C2410C] text-white transition-all whitespace-nowrap shadow-md hover:shadow-xl cursor-pointer active:scale-95 min-h-[44px]"
          >
